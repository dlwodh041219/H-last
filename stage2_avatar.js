...
let browBtn1 = { x: 0, y: 0, w: 90, h: 80 };
let browBtn2 = { x: 0, y: 0, w: 90, h: 80 };
let browBtn3 = { x: 0, y: 0, w: 90, h: 80 };
let browBtn4 = { x: 0, y: 0, w: 90, h: 80 };

let eyeBtn1 = { x: 0, y: 0, w: 90, h: 80 };
let eyeBtn2 = { x: 0, y: 0, w: 90, h: 80 };
let eyeBtn3 = { x: 0, y: 0, w: 90, h: 80 };
let eyeBtn4 = { x: 0, y: 0, w: 90, h: 80 };

let noseBtn1 = { x: 0, y: 0, w: 90, h: 80 };
let noseBtn2 = { x: 0, y: 0, w: 90, h: 80 };
let noseBtn3 = { x: 0, y: 0, w: 90, h: 80 };
let noseBtn4 = { x: 0, y: 0, w: 90, h: 80 };

let mouthBtn1 = { x: 0, y: 0, w: 90, h: 80 };
let mouthBtn2 = { x: 0, y: 0, w: 90, h: 80 };
let mouthBtn3 = { x: 0, y: 0, w: 90, h: 80 };
let mouthBtn4 = { x: 0, y: 0, w: 60, h: 50 };

let hairBtn1 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn2 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn3 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn4 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn5 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn6 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn7 = { x: 0, y: 0, w: 70, h: 70 };
let hairBtn8 = { x: 0, y: 0, w: 70, h: 70 };

let accBtn1  = { x: 0, y: 0, w: 70, h: 70 };
let accBtn2  = { x: 0, y: 0, w: 70, h: 70 };
let accBtn3  = { x: 0, y: 0, w: 70, h: 70 };
let accBtn4  = { x: 0, y: 0, w: 70, h: 70 };
let glassBtn1 = { x: 0, y: 0, w: 70, h: 70 };
let glassBtn2 = { x: 0, y: 0, w: 70, h: 70 };
let glassBtn3 = { x: 0, y: 0, w: 70, h: 70 };
let glassBtn4 = { x: 0, y: 0, w: 70, h: 70 };
...
function loadHumanEmojiAssets() {
  ...
  // emoji custom 2
  hairImg1 = loadImage('emojiImage/hair1.png');
  hairImg2 = loadImage('emojiImage/hair8.png');
  hairImg3 = loadImage('emojiImage/hair3.png');
  hairImg4 = loadImage('emojiImage/hair4.png');
  hairImg5 = loadImage('emojiImage/hair5.png');
  hairImg6 = loadImage('emojiImage/hair6.png');
  hairImg7 = loadImage('emojiImage/hair7.png');
  hairImg8 = loadImage('emojiImage/hair2.png');
...
function drawHumanEmojiStep1(margin) {
  ...
  browBtn2.x = width/2 + intervalX + 50;
  browBtn2.y = 2*margin + 170;
  
  browBtn3.x = width/2 + intervalX*2 + 50;
  browBtn3.y = 2*margin + 170;
  ...
  eyeBtn2.x = width/2 + intervalX + 50;
  eyeBtn2.y = 2*margin + intervalY + 145;
  
  eyeBtn3.x = width/2 + intervalX*2 + 50;
  eyeBtn3.y = 2*margin + intervalY + 145;
  
  eyeBtn4.x = width/2 + intervalX*3 + 50;
  ...
  noseBtn3.x = width/2 + intervalX*2 + 50;
  noseBtn3.y = 2*margin + intervalY*2 + 135;
  
  noseBtn4.x = width/2 + intervalX*3 + 50;
  noseBtn4.y = 2*margin + intervalY*2 + 130;
  ...
  mouthBtn3.x = width/2 + intervalX*2 + 50;
  mouthBtn3.y = 2*margin + intervalY*3 + 125;
  
  mouthBtn4.x = width/2 + intervalX*3 + 65;
  mouthBtn4.y = 2*margin + intervalY*3 + 145;
...
// 버튼 그리기 + 커지기
function drawButton(img, btn, baseScale = 1, isSelected = false) {
  let hover = isMouseOver(btn);
  let scale = baseScale * (hover ? 1.3 : 1);
...
function drawFacePanelWithCamera(panelX, panelY, panelW, panelH) {
  if(!video || video.width === 0 || !faceMeshReady){
    ...
    textFont(fontTemplate);
    textSize(30);
    text("카메라 로딩 중...", panelX + panelW/2, panelY + panelH/2);
    pop();
...
function drawEmojiFace() {
  ...
  let EYE_OFFSET_Y   = -5;
  let NOSE_OFFSET_Y  = 20;
  let MOUTH_OFFSET_Y = 47;
  let BROW_OFFSET_Y  = -25;
  ...
  if (mouthImgSel) {
    push();
    scale(-1,1);
    image(mouthImgSel, 0, MOUTH_OFFSET_Y, MOUTH_W, MOUTH_H);
    pop();
  }
  ...
  else if (selectedHairNum === 4 && hairImg4) image(hairImg4, 0.5, HAIR_OFFSET_Y, 206, 200);
  else if (selectedHairNum === 5 && hairImg5) image(hairImg5, 0.5, HAIR_OFFSET_Y-1, 210, 230);
  else if (selectedHairNum === 6 && hairImg6) image(hairImg6, 0.5, HAIR_OFFSET_Y, 202, 200);
  else if (selectedHairNum === 7 && hairImg7) image(hairImg7, 0, HAIR_OFFSET_Y,  210, 230);
  else if (selectedHairNum === 8 && hairImg8) image(hairImg8,0, HAIR_OFFSET_Y+1,  206, 225);
  ...
  // 안경
  if (selectedGlassNum === 1 && glassImg1) {
    image(glassImg1, 0, GLASS_OFFSET_Y, 202, 202);
  } else if (selectedGlassNum === 2 && glassImg2) {
    image(glassImg2, 0.5, GLASS_OFFSET_Y, 200, 200);
  } else if (selectedGlassNum === 3 && glassImg3) {
    image(glassImg3, 0.5, GLASS_OFFSET_Y, 205, 205);
  } else if (selectedGlassNum === 4 && glassImg4) {
    image(glassImg4, 0.5, GLASS_OFFSET_Y, 203, 203);
  }
